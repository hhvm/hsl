...
final class DictTransformTest extends HackTest {
  ...
  public static function provideTestChunk(): vec<(KeyedTraversable<arraykey, mixed>, int, vec<dict<arraykey, mixed>>)> {
    return vec[
      tuple(
        Map {},
        10,
  ...
  public static function provideTestCountValues(): vec<(Traversable<arraykey>, dict<arraykey, int>)> {
    return vec[
      tuple(
  ...
  public static function provideTestFillKeys(): vec<(Traversable<arraykey>, mixed, dict<arraykey, mixed>)> {
    return vec[
      tuple(
        darray[],
        'foo',
  ...
  public static function provideTestFlatten(): vec<(Traversable<KeyedContainer<arraykey, mixed>>, dict<arraykey, mixed>)> {
    return vec[
      tuple(
        darray[],
        dict[],
  ...
  public static function provideTestFlip(): vec<(KeyedTraversable<mixed, arraykey>, dict<arraykey, mixed>)> {
    return vec[
      tuple(
        darray[],
        dict[],
  ...
  public static function provideTestFromKeys(): vec<(Traversable<arraykey>, (function(nothing): mixed), dict<arraykey, mixed>)> {
    return vec[
      tuple(
        Set {},
        $x ==> $x,
  ...
  public static function provideTestFromEntries(): vec<(Traversable<(arraykey, mixed)>, dict<arraykey, mixed>)> {
    return vec[
      tuple(
        varray[
          tuple('foo', 1),
  ...
  public static function provideTestGroupBy(): vec<(Traversable<mixed>, (function(nothing): ?arraykey), dict<arraykey, vec<mixed>>)> {
    return vec[
      tuple(
  ...
  public static function provideTestMap(): vec<(KeyedTraversable<arraykey, mixed>, (function(nothing): mixed), dict<arraykey, mixed>)> {
    ...
    return vec[
      ...
      tuple(
        HackLibTestTraversables::getKeyedIterator(varray[1, 2, 3]),
        $x ==> $x * 2,
        dict(varray[2, 4, 6]),
      ),
      tuple(
  ...
  public static function provideTestMapKeys(): vec<(KeyedTraversable<mixed, mixed>, (function(nothing): arraykey), dict<arraykey, mixed>)> {
    return vec[
      tuple(
        dict[
          'the' => 'the',
  ...
  public static function provideTestMapWithKey(): vec<(KeyedTraversable<arraykey, mixed>, (function(nothing, nothing): mixed), dict<arraykey, mixed>)> {
    return vec[
      tuple(
        darray[],
        ($a, $b) ==> null,
  ...
  public static function provideTestPull(): vec<(Traversable<mixed>, (function(nothing): mixed), (function(nothing): arraykey), dict<arraykey, mixed>)> {
    return vec[
      tuple(
        Vector {'the', 'quick', 'brown', 'fox'},
        $x ==> $x,
  ...
  public static function provideTestPullWithKey(): vec<(KeyedTraversable<mixed, mixed>, (function(nothing, nothing): mixed), (function(nothing, nothing): arraykey), dict<arraykey, mixed>)> {
    return vec[
      tuple(
        Vector {'the', 'quick', 'brown', 'fox'},
        ($k, $v) ==> $k,
